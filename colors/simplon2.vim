...
hi CursorLineNr     guifg=#a1a1a1   guibg=#e6e6e6   gui=bold
...
" hi StatusLine       guifg=#e4e4e4   guibg=#2471a3   gui=bold
hi StatusLineNC     guifg=#404040   guibg=#d4d4d4   gui=none
...
" {{{ Completion menus
hi Pmenu            guifg=#ffffff   guibg=#515A5A     gui=bold
hi PmenuSbar        guifg=#444444   guibg=#000000
hi PmenuSel         guifg=#ffffff   guibg=#5DADE2   gui=bold
